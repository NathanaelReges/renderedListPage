...
/////////////////////Logica para renderizar enquanto o usuario scrolla  
        ...
        if(reverse){
            function addPostsAbove (arrayOfNewPosts) {
                ...
                for(let i = arrayOfNewPosts.length - 1; i >= 0; i--){
                    arrayOfItems.push(arrayOfNewPosts[i]) //pushToArrayOfiItems
                }
            ...
            function addPostsUnder (arrayOfNewPosts) {
                ...
                for(let i = length - 1; i >= 0; i--){
                    arrayOfItems.unshift(arrayOfNewPosts[i]) //unshiftToArrayOfiItems
                }                 
                ...
                if(scrollY >= container0EleHeight - scrollerEleHeight){ 
                    requestAnimationFrame(()=>{
                        addToContainer0Height(height)
                        scrollerEle.scrollTop = scrollY + height + 1000 //setScrollTop
                        checkScroll()
                    })
    ...
    //////////////////Module
        ...
        module.reRender = ({addedItem, removedItem} = {}) => { 
            ...
            if(addedItem){
                ...
                if(indexOfLowestItem != 0) {
                    ...
                    const length = -(arrayOfItems[0].offsetHeight + itemMargin)
                    moveContainer2(length)
                    addToContainer0Height(length)
